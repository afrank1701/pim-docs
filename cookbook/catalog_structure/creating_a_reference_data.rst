...
To create a reference data, an Entity have to implement `Pim\\Component\\ReferenceData\\Model\\ReferenceDataInterface`.
This is the recommended way to do is to extend the abstract class `Pim\\Component\\ReferenceData\\Model\\AbstractReferenceData`.
...
To link a reference data to the product, the `ProductValue` object need to be overriden.
