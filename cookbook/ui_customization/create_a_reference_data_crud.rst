...
Now the grid is created and the required form for both creation and update,
The last step is to declare the reference data as "custom entity":
...
.. note::
    ...
    The same form type for both creation and edition tasks.
